...
const Hero = () => {
  return <section className={styles.container}>
    <div className={styles.content}>
        ...
        <p className={styles.description}>I’m a Full Stack Developer and a Software Engineering undergraduate who loves building cool web apps and bringing ideas to life! With a blend of frontend and backend skills, I'm all about creating user-friendly, impactful digital experiences. Let's create something amazing together! </p>
